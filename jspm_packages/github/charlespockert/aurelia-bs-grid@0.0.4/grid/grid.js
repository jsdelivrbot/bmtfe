/* */ 
define(["exports","aurelia-framework","./grid-column","charlespockert/aurelia-compiler","./aurelia-bs-grid.css!css"], function (exports, _aureliaFramework, _gridColumn, _CharlesPockertAureliaCompiler, _aureliaBsGridCss) {
	'use strict';
